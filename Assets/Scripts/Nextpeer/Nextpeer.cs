...
//    public TournamentType TournamentType;
	...
	/// The modifier can be negative or positive and thus points will either be added or reduced from the recordingвЂ™s score.
	/// </summary>
	/// <param name='userId'>
	...
	{
        Settings.gametype = Settings.GameType.Tournament;
//        SceneManager.LoadSceneAsync(2);
        NPTournamentStartDataContainer _npTournamentStartDataContainer = getINextpeerInstance().GetTournamentStartData();

        switch (_npTournamentStartDataContainer.TournamentUUID)
        {
            case "NPA456031669203434789":
                Settings.tournamentType = Settings.TournamentType.HighScore;
                break;
            case "NPA456031669203434826":
                Settings.tournamentType = Settings.TournamentType.TimeGame;
                break;
            case "NPA456031669203434499":
                Settings.tournamentType = Settings.TournamentType.HighScore;
                break;
            case "NPA456031669203434749":
                Settings.tournamentType = Settings.TournamentType.TimeGame;
                break;
        }
...
//            if (Settings.gametype == Settings.GameType.NoType) SceneManager.LoadScene(1);
